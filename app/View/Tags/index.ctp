<div class="tags index">
	...
	<tr>
		...
		<td><?php echo h($tag['Tag']['status']); ?>&nbsp;</td>
		<td><?php echo h($tag['Tag']['is_active']); ?>&nbsp;</td>
		<td><?php echo h($tag['Tag']['is_delete']); ?>&nbsp;</td>
		<td><?php echo h($tag['Tag']['created']); ?>&nbsp;</td>
		<td><?php echo h($tag['Tag']['created_by']); ?>&nbsp;</td>
		<td><?php echo h($tag['Tag']['modified']); ?>&nbsp;</td>
		<td><?php echo h($tag['Tag']['modified_by']); ?>&nbsp;</td>
		<td class="actions">
